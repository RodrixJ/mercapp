...
class mapaModel extends Model{
    ...
    public function obtenerdatos(){
        return $this->_db->query("select * from ubicacion_descanso inner join defunciones on defuncion_id_defuncion=id_defuncion inner join galeria on galeria.defuncion_id_defuncion=id_defuncion")->fetchAll();
    }
